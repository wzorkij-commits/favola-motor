...
const files = ['../lib/data.js','../lib/providers.js','../lib/prompts.js','../lib/guardrails.js',
  ...
  '../api/account.js','../lib/h-spend.js','../api/pay.js','../lib/h-paystatus.js','../lib/route.js','../lib/record.js','../lib/bible.js','../lib/catalog.js','../lib/recipe.js','../lib/variety.js','../lib/lessons.js','../lib/owner.js'];
let bad = 0;
